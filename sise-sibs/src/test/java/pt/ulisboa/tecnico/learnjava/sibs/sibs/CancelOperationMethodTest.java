...
public class CancelOperationMethodTest {
	...
	public void cancelOperationTest()
		...
		TransferOperation canceledOperation = (TransferOperation) this.sibs.getOperation(0);
		this.sibs.cancelOperation(0);

		assertTrue(canceledOperation.getStateContext().getCurrentState() instanceof CANCELLED);
	}
